...
public class EspecialidadeService {
	...
	public Especialidade buscarPorCodigo(int codigoEspecialidade) throws SQLException, IOException {

		Connection conn = BancoDados.conectar();
		return new EspecialidadeDAO(conn).buscarPorCodigo(codigoEspecialidade);
	}
